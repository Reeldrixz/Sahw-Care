...
export default function ShareImpactModal({ onClose }: Props) {
  ...
  const shareText = stats?.donations
    ? `I've helped ${stats.families} ${stats.families === 1 ? "family" : "families"} through Kradel 💛 ${stats.donations} donation${stats.donations !== 1 ? "s" : ""} and counting. Every baby deserves support. Join me:`
    : `I just joined Kradel 💛 — a community helping mothers and babies get essentials they need. Join us:`;
