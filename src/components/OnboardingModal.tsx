...
type Journey = "pregnant" | "postpartum" | null;
...
export default function OnboardingModal({ onComplete }: Props) {
  ...
  const goStep2 = (j: Journey) => { setJourney(j); setStep(1); };
        ...
        <div style={{ overflow: "hidden" }}>
          <div style={{
            ...
            <div style={{ minWidth: "100%", padding: "24px 24px 32px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                >
                  ...
                  <div>
                    <div style={{ fontSize: 16, fontWeight: 800, fontFamily: "Nunito, sans-serif", color: "var(--ink)" }}>I&apos;m pregnant</div>
                    <div style={{ fontSize: 12, color: "var(--mid)", marginTop: 2 }}>Join your pregnancy stage group</div>
                  </div>
                </button>

                <button
                  onClick={() => goStep2("postpartum")}
                  style={{
                    display: "flex", alignItems: "center", gap: 16,
                    padding: "20px 22px", borderRadius: 18,
                    border: "2px solid var(--border)",
                ...
                >
                  <span style={{ fontSize: 36 }}>👶</span>
                  <div>
                    <div style={{ fontSize: 16, fontWeight: 800, fontFamily: "Nunito, sans-serif", color: "var(--ink)" }}>My baby is here</div>
                    <div style={{ fontSize: 12, color: "var(--mid)", marginTop: 2 }}>Join your baby&apos;s age group</div>
                  </div>
                </button>
              </div>

              <p style={{ fontSize: 11, color: "var(--light)", textAlign: "center", marginTop: 20, lineHeight: 1.5 }}>
                Your circle is matched to your exact stage. It updates automatically as you progress. 💛
              </p>
            </div>
            ...
            <div style={{ minWidth: "100%", padding: "24px 24px 32px" }}>
              {journey === "pregnant" ? (
                ...
                <>
                  ...
                  <div style={{ fontSize: 13, color: "var(--mid)", textAlign: "center", marginBottom: 20, lineHeight: 1.6 }}>
                    Choose the closest match — this places you in the right group.
                  </div>
              ...
              {error && (
                <div style={{ fontSize: 12, color: "var(--terra)", background: "var(--terra-light, #fdf0e8)", padding: "8px 12px", borderRadius: 8, marginBottom: 12, fontWeight: 600 }}>
                  {error}
                </div>
              )}
