            ...
            {section === "overview" && stats && (
              <>
                ...
                <div style={{ display: "flex", gap: 12, marginBottom: 20, flexWrap: "wrap" }}>
                  ...
                  <a href="/admin/fundraising-events" style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", background: "white", border: "1px solid var(--border)", borderRadius: 12, textDecoration: "none", fontFamily: "Nunito, sans-serif", fontSize: 13, fontWeight: 700, color: "var(--ink)" }}>
                    📣 Fundraising Events
                    <ExternalLink size={12} color="var(--mid)" />
                  </a>
                </div>
