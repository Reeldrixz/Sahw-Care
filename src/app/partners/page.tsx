  ...
  return (
    <main style={{ background: CREAM, color: INK, minHeight: "100vh", fontFamily: SANS }}>
      ...
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 22px", maxWidth: 1040, margin: "0 auto" }}>
        <Link href="/" style={{ fontFamily: SERIF, fontSize: 22, fontWeight: 700, color: INK, textDecoration: "none" }}>Kradel</Link>
      ...
      <section style={{ maxWidth: 760, margin: "0 auto", padding: "24px 22px 8px", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: SERIF, fontSize: 34, fontWeight: 700, lineHeight: 1.2, margin: "0 0 16px" }}>
          Local businesses stand behind Kradel&apos;s mothers
        </h1>
      ...
      <section style={{ maxWidth: 1040, margin: "0 auto", padding: "28px 22px 8px" }}>
        <p style={{ fontFamily: SANS, fontSize: 14, lineHeight: 1.6, color: MUTED, textAlign: "center", margin: "0 auto 8px", maxWidth: 640 }}>
          Give once at Bronze, Silver, or Gold, or join as a recurring Kradel Care Partner.
        </p>
        <p style={{ fontFamily: SANS, fontSize: 13.5, lineHeight: 1.6, color: MUTED, textAlign: "center", margin: "0 auto 20px", maxWidth: 640 }}>
          Whichever tier you choose, your business is recognised as a Kradel Community Partner and can appear in our{" "}
          <Link href="/community-partners" style={{ color: GREEN, fontWeight: 700, textDecoration: "none" }}>
            public partner directory
          </Link>
          , the facts-based record of the businesses funding real support.
        </p>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: "6px 0 0", display: "flex", flexDirection: "column", gap: 6 }}>
                  {t.perks.map((p) => (
                    <li key={p} style={{ fontFamily: SANS, fontSize: 13, color: INK, display: "flex", gap: 8, lineHeight: 1.4 }}>
                      <span aria-hidden style={{ width: 5, height: 5, borderRadius: "50%", background: t.accent, flexShrink: 0, marginTop: 6 }} />{p}
                    </li>
                  ))}
                </ul>
              )}
        ...
        {PARTNERS.length === 0 ? (
          <div style={{ background: "#fff", border: `1.5px dashed ${CARD_BORDER}`, borderRadius: 18, padding: "36px 24px", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: SANS, fontSize: 14, color: MUTED, margin: 0, lineHeight: 1.6 }}>
              Be the first business behind Kradel&apos;s mothers.
            </p>
          </div>
        ) : (
